import { BlogSvg, BonusUISvg, ButtonsSvg, CalanderSvg, ChartsSvg, ChatSvg, ContactSvg, EcommerceSvg, EditorsSvg,
     EmailSvg, FAQSvg, FilemanagerSvg, FormsSvg, GallarySvg, HeaderBookmarkSvg, HomeSvg, IconsSvg,
      JobsearchSvg, KanbanSvg, KnowledgebaseSvg, LearningSvg, MapsSvg, OthersSvg, ProjectSvg,
       SamplePageSvg, SearchResultSvg, SocialappSvg, SupportTicketSvg, TablesSvg, TaskSvg, TodoSvg,
        UiKitsSvg, UsersComponentSvg, WidgetsSvg , AdminUsersSvg } from '../../Data/svgIcons';

export const MENUITEMS = [
    // {
    //     menutitle: 'Admin',
    //     Items: [
    //         { path: `${process.env.PUBLIC_URL}/admin/panel`, bookmark: true, icon: AdminUsersSvg, title: 'Admin', type: 'link' }
    //     ]
    // },
    {
        menutitle: 'Admin',
        Items: [
            {
                title: 'Admin', icon: AdminUsersSvg, type: 'sub', badge:  false, active: false, children: [
                    { path: `${process.env.PUBLIC_URL}/admin/Category`, title: 'Category', type: 'link' },

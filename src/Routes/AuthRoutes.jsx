...
import CreateAccount from '../Component/Pages/Auth/CreateAccount';
import FirstIntroPage from "../Pages/FirstIntroPage/FirstInroPage"
...
export const authRoutes = [
  ...
  { path: `${process.env.PUBLIC_URL}/pages/authentication/register`, Component: <RegisterSimple /> },//check
